...
export TENSORBOARD_DIR=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-admodel-train/hadoop-hmart-waimaiad/gongji/yuyongcan/code/TTRL/verl/logs/tensorboard_${TASK}_${BACKBONE}/${EXP_NAME}
...
BACKBONE_PATH="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-admodel-train/hadoop-hmart-waimaiad/gongji/yuyongcan/checkpoints/huggingface.co/meta-llama/${BACKBONE}"
