...
export TENSORBOARD_DIR=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-admodel-train/hadoop-hmart-waimaiad/gongji/yuyongcan/code/TTRL/verl/logs/tensorboard_debug/${EXP_NAME}
WANDB_PROJECT="TTRL-debug-${EXP_NAME}"
