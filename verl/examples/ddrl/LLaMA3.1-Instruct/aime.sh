...
BACKBONE_PATH="/path/to/DDRL/verl/checkpoints/huggingface.co/meta-llama/${BACKBONE}"
...
# ------------------------------------------------------------
CUDA_VISIBLE_DEVICES=0,1,2,3,4 python -m verl.trainer.main_ppo \
