...
ADVANTAGE="grpo"
BACKBONE_PATH="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-admodel-train/hadoop-hmart-waimaiad/gongji/yuyongcan/code/LLaMA-Factory/saves/Qwen2_5_MATH_1_5B_AMC/full/sft_20epoch_ttrl"
