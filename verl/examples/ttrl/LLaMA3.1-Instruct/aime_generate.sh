...
EXP_NAME="generate_8gpus"
export WANDB_DIR=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-admodel-train/hadoop-hmart-waimaiad/gongji/yuyongcan/code/TTRL/verl/logs/wandb_${TASK}_${BACKBONE}/${EXP_NAME}
export TENSORBOARD_DIR=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-admodel-train/hadoop-hmart-waimaiad/gongji/yuyongcan/code/TTRL/verl/logs/tensorboard_generate_${TASK}_${BACKBONE}/${EXP_NAME}
...
BACKBONE_PATH="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-admodel-train/hadoop-hmart-waimaiad/gongji/yuyongcan/code/TTRL/verl/checkpoints/TTRL-verl-TTRL_pnsr_both_sel_dyn_2e-7_2/MATH-TTT-Llama-3.1-8B-Instruct/1226/TTRL-Len@3k-psr_nsr_reinforce-133210/global_step_150/actor/merged-hf"
